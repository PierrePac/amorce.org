 ...
 */
class Commercial extends \App\Entity\Commercial implements \Doctrine\Persistence\Proxy
{
    ...
    private const LAZY_OBJECT_PROPERTY_SCOPES = [
        ...
        "\0".parent::class."\0".'specificite' => [parent::class, 'specificite', null],
        'clients' => [parent::class, 'clients', null],
        'id' => [parent::class, 'id', null],
        'nom' => [parent::class, 'nom', null],
        'prenom' => [parent::class, 'prenom', null],
        'specificite' => [parent::class, 'specificite', null],
    ];
